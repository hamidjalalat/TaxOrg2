...
namespace Resources.Messages {
    ...
    public class Successes {
        ...
        /// <summary>
        ///   Looks up a localized string similar to اگر ایمیل وارد معتبر باشد، لینک فراموشی رمزعبور به ایمیل شما ارسال شد.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to کد یک بار مصرف ارسال گردید.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to برای ارسال دوباره کد، لطفا {0} ثانیه صبر کنید.
        /// </summary>
        public static string WaitingForResendOtpCode {
            get {
                return ResourceManager.GetString("WaitingForResendOtpCode", resourceCulture);
            }
        }
    }
}
