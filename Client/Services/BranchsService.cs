...
{
	public class BranchsService : Infrastructure.ServiceBase
	{
        // ********************
        #region Properties
            ...
            ) : base(httpClient, logsService, configuration, tokenService, authStateProvider)
        {
            ...
            strServiceUri = $"{Infrastructure.Utility.setServiceUri<BranchsService>()}";
		}
        ...
        public async
            ...
            <ViewModels.Branchs.BranchActiveViewModel>>>
			FetchActiveAsync(ViewModels.Shared.PublicViewModel inputParamsViewModel)
        {
            ...
            var result =
                ...
                Nazm.Results.Result<ViewModels.PagingViewModel<ViewModels.Branchs.BranchActiveViewModel>>>
