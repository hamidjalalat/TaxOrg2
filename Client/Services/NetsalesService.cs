...
{
	public class NetsalesService : Infrastructure.ServiceBase
	{
        // ********************
        #region Properties
            ...
            ) : base(httpClient, logsService, configuration, tokenService, authStateProvider)
        {
            ...
            strServiceUri = $"{Infrastructure.Utility.setServiceUri<NetsalesService>()}";
		}
        ...
        public async
            ...
            <ViewModels.Netsales.NetsaleActiveViewModel>>>
			FetchActiveAsync(ViewModels.Shared.PublicViewModel inputParamsViewModel)
        {
            ...
            var result =
                ...
                Nazm.Results.Result<ViewModels.PagingViewModel<ViewModels.Netsales.NetsaleActiveViewModel>>>
