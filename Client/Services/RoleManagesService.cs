...
{
    public class RoleManagesService : Infrastructure.ServiceBase
	{
        // ********************
        #region Properties
            ...
            ) : base(httpClient, logsService, configuration, tokenService, authStateProvider)
        {
            ...
            strServiceUri = $"{Infrastructure.Utility.setServiceUri<RoleManagesService>()}";
		}
		...
		public async
			...
			<ViewModels.RoleManages.RoleManageViewModel>>>
			FetchAsync(ViewModels.Shared.PublicViewModel inputParamsViewModel)
		{
			...
			var result =
				...
				Nazm.Results.Result<ViewModels.PagingViewModel<ViewModels.RoleManages.RoleManageViewModel>>>
		...
		public async
		  ...
		  <Nazm.Results.Result
		  <ViewModels.RoleManages.RoleManageViewModel>>
		  PostAsync(ViewModels.RoleManages.RoleManageCreateViewModel viewModel)
		{
			try
			{
				...
				var result =
					await
					PostAsync
					<ViewModels.RoleManages.RoleManageCreateViewModel,
					Nazm.Results.Result<ViewModels.RoleManages.RoleManageViewModel>>
					(url: url, viewModel);
		...
		<Nazm.Results.Result
		<ViewModels.RoleManages.RoleManageViewModel>>
		PutAsync(ViewModels.RoleManages.RoleManageUpdateViewModel viewModel)
		{
			try
			{
				string url = $"{strServiceUri}";
				...
				var result =
					await
					PutAsync
					<ViewModels.RoleManages.RoleManageUpdateViewModel,
					Nazm.Results.Result<ViewModels.RoleManages.RoleManageViewModel>>
					(url: url, viewModel);
