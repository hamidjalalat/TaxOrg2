...
namespace Domain.Rich.SharedKernel
{
    public class Gender : Enumeration
    {
        ...
        public static FluentResults.Result<Gender> GetByValue(int? value)
        {
            ...
            // **************************************************
            var genderResult = GetByValue<Gender>
                (value: value, name: Resources.DataDictionary.Gender);
            // **************************************************

            // **************************************************
            if (genderResult.IsFailed)
            {
                result.WithErrors(errors: genderResult.Errors);

                return result;
            }
            // **************************************************

            var returnValue = new Gender
                (value: genderResult.Value.Value,
                name: genderResult.Value.Name);
