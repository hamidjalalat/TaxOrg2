...
namespace Application.Features.Anemic.ActionMethods.Queries
{
    ...
    public class ActionMethodGetAllQuery : BaseRequest, IRequest<Result<PaginatedList<ActionMethodViewModel>>>
    {
        private ActionMethodGetAllQuery()
        {

        }
        public ActionMethodGetAllQuery(PublicViewModel viewModel)
        {
    ...
    public class ActionMethodGetAllQueryHandler : BaseRequestHandler<ActionMethodGetAllQuery, Result<PaginatedList<ActionMethodViewModel>>>
    {
        private readonly IActionMethodRepository _ActionMethodRepository;


        public ActionMethodGetAllQueryHandler(
        ...
        protected async override Task<Result<PaginatedList<ActionMethodViewModel>>> HandleRequestAsync(ActionMethodGetAllQuery input, CancellationToken cancellationToken)
        {
            var result = new FluentResults.Result<PaginatedList<ActionMethodViewModel>>();
            var query = _unitOfWork.ActionMethods.GetAll.AsNoTracking();
