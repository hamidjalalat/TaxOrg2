...
namespace Application.Features.Anemic.MenuControllers.Queries
{
    ...
    public class MenuControllerGetAllQuery : BaseRequest, IRequest<Result<PaginatedList<MenuControllerViewModel>>>
    {
        private MenuControllerGetAllQuery()
        {

        }
        public MenuControllerGetAllQuery(PublicViewModel viewModel)
        {
    ...
    public class MenuControllerGetAllQueryHandler : BaseRequestHandler<MenuControllerGetAllQuery, Result<PaginatedList<MenuControllerViewModel>>>
    {
        private readonly IMenuControllerRepository _MenuControllerRepository;


        public MenuControllerGetAllQueryHandler(
        ...
        protected async override Task<Result<PaginatedList<MenuControllerViewModel>>> HandleRequestAsync(MenuControllerGetAllQuery input, CancellationToken cancellationToken)
        {
