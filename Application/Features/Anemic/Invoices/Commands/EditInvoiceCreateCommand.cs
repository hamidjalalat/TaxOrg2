...
{
    public class EditInvoiceCreateCommand : BaseRequest, IRequest<Result<string>>
    {
        public InvoiceCreateViewModel InvoiceViewModel { get; set; }

    }

    public class EditInvoiceCreateCommandHandler : BaseRequestHandler<EditInvoiceCreateCommand, Result<string>>
    {
        ...
        protected override async Task<Result<string>> HandleRequestAsync(EditInvoiceCreateCommand input, CancellationToken cancellationToken)
        {
            try
            {
