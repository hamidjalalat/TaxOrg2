...
public class Nazm_tspagentUpdateViewModelValidator : AbstractValidator<Nazm_tspagentUpdateViewModel>
{
    public Nazm_tspagentUpdateViewModelValidator()
    {
       ...
       .WithName(Resources.DataDictionary.indatim);
        ...
        RuleFor(I => I.inno)
               .NotEmpty().WithMessage(string.Format(Resources.Messages.Validations.Required, ConstClass.PropertyName))
               .WithName(Resources.Messages.Validations.Inno);
        ...
        RuleFor(I => I.Policy_No)
            ...
            .WithName(Resources.Messages.Validations.PolicyNo);
