...
{
    public class TaxOrganizationSaleUpdateViewModelValidator : AbstractValidator<TaxOrganizationSaleUpdateViewModel>
    {
        public TaxOrganizationSaleUpdateViewModelValidator()
        {
