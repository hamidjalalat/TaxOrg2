...
{
    public class TaxOrganizationSaleForGridViewModelValidator : AbstractValidator<TaxOrganizationSaleForGridViewModel>
    {
        public TaxOrganizationSaleForGridViewModelValidator()
        {
