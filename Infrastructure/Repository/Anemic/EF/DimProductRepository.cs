...
{
    public class DimProductRepository : EFRepository<DimProduct>, IDimProductRepository
    {
        public DimProductRepository(EFContext context) : base(context)
        {
        }
        public async Task<Result<bool>> IsUnique(DimProduct model,CancellationToken cancellationToken)
        {
