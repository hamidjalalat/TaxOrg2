...
{
    public class InvoiceModelRepository : EFRepository<InvoiceModel>, IInvoiceModelRepository
    {
        public InvoiceModelRepository(EFContext context) : base(context)
        {
        }
        public async Task<Result<bool>> IsUnique(InvoiceModel model,CancellationToken cancellationToken)
        {
