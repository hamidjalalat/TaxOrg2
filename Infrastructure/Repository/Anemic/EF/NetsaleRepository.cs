...
{
    public class NetsaleRepository : EFRepository<Netsale>, INetsaleRepository
    {
        public NetsaleRepository(EFContext context) : base(context)
        {
        }
        public async Task<Result<bool>> IsUnique(Netsale model, CancellationToken cancellationToken)
        {
