...
{
    public class CancelInvoicesController : ApiControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody] InvoiceCreateViewModel viewModel, CancellationToken cancellationToken)
        {
            ...
            var result = await Mediator.Send(new CancelInvoiceCreateCommand { InvoiceViewModel = viewModel }, cancellationToken);
